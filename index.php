...
<html lang="en">
    <head>
        ...
        <title>AndrieShop | Online Shop</title>
    </head>
    <body>
        <div class="container">
            <div class="row mt-3">
                <div class="col-8">
                    <h1><i class="fa fa-store"></i>AndrieShop</h1>
                </div>
                                    ...
                                    <div class="product-grid2">
                                        <div class="product-image2 h-100">
                                            <a href="details.php?itemkey=<?php echo $key; ?>">
                                                <img class="pic-1 h-100" src="img/<?php echo $product['photo1']; ?>">
                                                <img class="pic-2 h-100" src="img/<?php echo $product['photo2']; ?>">
                                            </a>
